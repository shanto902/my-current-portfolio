...
export const LogoSVG = ({ className, ...rest }) => (
<svg
     xmlns="http://www.w3.org/2000/svg"
     width="1em"
     height="1em"
  ...
  >
    <defs>
      <circle id="a" cx={350} cy={350} r={350} />
    </defs>
    <g fill="none" fillRule="evenodd">
      ...
      <g fill="currentColor" fillRule="nonzero" mask="url(#b)">
        <path d="M166.286 187c8.03 0 16.687.503 25.97 1.508a305.147 305.147 0 0 1 27.1 4.148c8.783 1.76 16.813 3.52 24.09 5.279 7.277 1.76 12.923 3.645 16.937 5.656v83.707h-6.775c0-24.132-8.28-43.11-24.841-56.936s-36.636-20.738-60.223-20.738c-27.601 0-49.934 8.672-66.997 26.017-17.063 17.345-25.594 37.58-25.594 60.707 0 9.552 2.133 20.738 6.398 33.558 4.266 12.82 12.17 24.76 23.713 35.82l148.297 137.25c15.056 14.078 25.093 29.16 30.111 45.248 5.019 16.088 7.528 31.673 7.528 46.755 0 41.728-12.672 75.664-38.015 101.807C228.64 722.929 194.39 736 151.23 736c-12.045 0-26.222-1.257-42.532-3.77a207.763 207.763 0 0 1-47.425-13.198c-15.307-6.284-27.979-14.454-38.016-24.509C21.753 686.48 21 676.424 21 664.36c0-12.066 1.004-24.76 3.011-38.084 2.008-13.322 4.768-25.514 8.28-36.574h6.776c-2.51 25.64.752 48.012 9.786 67.116 9.033 19.105 22.207 33.559 39.52 43.362 17.314 9.804 37.012 14.203 59.094 13.197 27.602-1.508 51.314-11.186 71.137-29.033 19.823-17.848 29.735-41.854 29.735-72.019 0-14.58-2.51-27.777-7.528-39.591-5.018-11.815-12.295-21.995-21.83-30.542L74.447 407.957c-15.055-14.077-25.594-29.536-31.616-46.378-6.023-16.842-9.034-32.553-9.034-47.133 0-21.115 5.019-41.476 15.056-61.083 10.037-19.608 24.967-35.57 44.79-47.887S137.681 187 166.286 187Zm94.097 7.541v15.837h-57.21V194.54h57.21Z" />
      </g>
      <g fill="currentColor" fillRule="nonzero" mask="url(#b)">
        <path d="M221-25h51.27L390 352.142 379.24 421 221-25Zm280.964 161L507 167.71 396.214 377.545l-3.147 6.851c-2.098 4.568-4.196 10.179-6.295 16.834-2.098 6.655-3.357 13.245-3.776 19.77h-5.666L366 386.158 496.3 136h5.664Zm1.356 1L635 367.09l-9.69 47.263-.51 6.647L482 179.19 503.32 137ZM826 18 652.822 357.639l-4.63 10.275c-3.088 6.85-6.329 15.126-9.725 24.83-3.395 9.704-5.402 19.123-6.02 28.256h-8.334L613 364.489 774.14 18H826Zm-112.416 0c3.357-13.056 2.308-23.065-3.147-30.028-5.456-6.963-12.38-10.444-20.772-10.444H684V-29h124v6.528h-5.036c-9.651 0-20.142 3.155-31.472 9.465C760.162-6.697 752.19 3.64 747.574 18h-33.99ZM284.36 18h-49.82c-5.045-14.361-13.138-24.697-24.279-31.007-11.14-6.31-21.546-9.465-31.216-9.465H174V-29h140v6.528h-5.676c-7.988 0-15.03 3.481-21.126 10.444-6.096 6.963-7.042 16.972-2.838 30.028Z" />
      </g>
    </g>
  </svg>
);
