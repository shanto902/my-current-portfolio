...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark cursor-pointer absolute dark:text-dark dark:bg-light lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent xs:text-dark xs:dark:text-light lg:p-6 md:p-4 xs:text-xs xs:p-2"
...
const Skills = () => {
  return (
    <>
      <h2 className=" font-bold text-8xl mt-64 w-full text-center mb-16 md:text-6xl md:mt-32 ">
        Skills
      </h2>
      <div
      ...
      >
        ...
        <Skill name="Typescript" x="-27vw" y="2vw" />
        ...
        <Skill name="Web Socket" x="14vw" y="-12vw" />
        <Skill name="Express" x="34vw" y="-5vw" />
        <Skill name="MongoDB" x="0vw" y="-21vw" />
        <Skill name="Mongoose" x="-25vw" y="18vw" />
